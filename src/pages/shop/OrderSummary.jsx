...
const OrderSummary = () => {
  ...
  // distructure products selectedItems and totalPrice from cart
  ...
  return (
    <>
      <div className=" bg-pink-200 mt-5 rounded text-base">
        ...
        <div className="px-4 pb-6">
          ...
          <button onClick={(e) => {e.stopPropagation(); makePayment()}} className="bg-green-600 px-3 py-1.5 text-white  mt-2 rounded-md flex justify-between items-center">
            <span className="mr-2 cursor-pointer">Proceed Checkout</span>
